            ...
            <div class="row">
                <div class="col-xl-12 col-xxl-12 col-sm-12">
                    ...
                    @if (session('addMediaMessage'))
                        <div class="alert my-3" style="  color: #0f5132;
                        ...
                        <div class="card-body">
                            <form method="post" action="{{ route('medias.store') }}" enctype="multipart/form-data" style="z-index: -100">
                                ...
                                <div class="col-md-12  my-4 text-center m-auto form-group">
                                    ...
                                    <input type="submit" value="AJOUTER MEDIA(S)"
                                        class="btn col-md-2 p-2 my-4  text-white font-weight-bold border-0 btn-primary" name="addMedia"
                                        id="addMedia">
                                </div>
