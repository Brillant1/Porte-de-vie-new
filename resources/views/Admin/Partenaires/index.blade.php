...
<div class="row page-titles mx-0">
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0);">Tous les partenaires</a></li>
        </ol>
    </div>
</div>
                            ...
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $partenaire->message }}</td>
                                        <td>{{ \Carbon\Carbon::parse($partenaire->created_at)->format('d-m-Y') }}</td>
                                        ...
                                        <td class="d-flex">
                                            ...
                                            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    Êtes vous sûr de vouloir supprimer cet témoignage ?
                                                    </div>
                                                    <div class="modal-footer">
                                                        <form action="{{ route('activites.destroy', $partenaire->id) }}" method="POST">
                                                            @csrf
                                                            @method('DELETE')
