...
<div class="row page-titles mx-0">
    ...
    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active"><a href="javascript:void(0);">Tous les services</a></li>
        </ol>
    </div>
</div>
            ...
            <div id="list-view" class="tab-pane fade active show col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('services.create') }}" class="btn btn-primary">+ Ajouter un nouveau</a>
                    </div>
                            ...
                            <table id="example3" class="display" style="min-width: 845px">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><img class="rounded-circle" width="35" src="{{ asset('storage/'.$service->photo) }}" alt=""></td>
