...
@section('content')
    <section>
        <div class="hero-slider position-relative">
            ...
            <div class="hero-slider-item py-5" style="background-image: url({{ asset('front/images/pdv2.jpeg') }});"
                data-icon="ti-comments" data-text="L'église">
                <div class="container-fluid d-flex justify-content-center bg-dark h-100 py-160" style="opacity:0.7">
                    <div class="w-75 ">
                        <div class="">
                            <div class="row ">
                                <div class="col-12">
                                    <div class="hero-content">
                                        ...
                                        <h1 class="font-weight-bold mb-3 text-white" data-duration-in=".5"
                                            data-animation-in="fadeInLeft" data-delay-in=".5">
                                            Nous avons une chaîne télévisée</h1>
                                        <h4 class="mb-50 text-white w-75 mt-3" data-duration-in=".5"
                                            data-animation-in="fadeInLeft" data-delay-in=".9"> Nous communiquons l'oeuvre du Christ ressuscité à travers notre chaîne de télévision.
                                                </p>
                                                <a data-duration-in=".5" data-animation-in="fadeInDown" data-delay-in="1.3"
                                                    href="{{ route('about') }}"
                                                    class="btn border border-white text-uppercase text-white font-weight-bold mt-3 bg-white text-dark">Nous
            ...
            <div class="hero-slider-item py-5" style="background-image: url({{ asset('front/images/pdv3.jpeg') }});"
                data-icon="ti-money" data-text="Chaîne télévisée">
                <div class="container">
                    <div class="row">
                        <div class="col-12">
                            <div class="hero-content">
            ...
            <div class="hero-slider-item py-160" style="background-image: url({{ asset('front/images/pdv5.jpeg') }});"
                            ...
                            <img src="{{ asset('storage/' .$activite->photo) }}" class="card-img-top" alt="">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mt-2">
                                        ...
                                        <a href="{{ route('services.show', encrypt($activite->id)) }}" class="">Voir détail
                                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                                fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                                                <path fill-rule="evenodd"
                                                    d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8z" />
